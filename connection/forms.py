...
class LineForm(forms.ModelForm):
    class Meta:
        model = Line
        fields = ["customer", "location", "description", "isActive"]
        widgets = {
            "isActive": forms.CheckboxInput(attrs={"class": "toggle toggle-success"}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["customer"].queryset = self.fields["customer"].queryset.order_by("firstName", "lastName")
